    ...
    <PublicLayout>
      ...
      <section
        ...
        style={{
          position: "relative",
          minHeight: "100vh",
          backgroundImage: "url('/manus-storage/contacts_hero_new_7a2e3d7c.png')",
            ...
            >
              ...
              <div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", borderBottom: "1px solid rgba(201,169,110,0.15)", paddingBottom: "12px" }}>
                  <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", color: "rgba(240,237,232,0.4)" }}>Сб — Вс</span>
