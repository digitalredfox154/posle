      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "clamp(6px, 1vw, 14px)" }}>
              <div style={{ width: "24px", height: "1px", backgroundColor: "rgba(184,150,90,0.4)" }} />
              <span style={{ color: "#B8965A", fontSize: "clamp(7px, 0.65vw, 10px)" }}>&#10022;</span>
            </div>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(9px, 0.85vw, 13px)", color: "rgba(14,14,14,0.58)", lineHeight: 1.8, marginBottom: "clamp(5px, 0.8vw, 12px)" }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(9px, 0.85vw, 13px)", color: "rgba(14,14,14,0.58)", lineHeight: 1.8 }}>
          ...
          {/* ── CARD 01 top-left ── */}
          <div style={{ position: "absolute", left: "52.5%", top: "9%", width: "21%", height: "40%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "4% 4% 5%" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(20px, 2.8vw, 42px)", fontWeight: 300, color: "rgba(168,197,181,0.7)", lineHeight: 1 }}>01</span>
              <div style={{ width: "clamp(28px,2.8vw,42px)", height: "clamp(28px,2.8vw,42px)", borderRadius: "50%", border: "1px solid rgba(168,197,181,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(14px, 1.7vw, 24px)", fontWeight: 300, color: "#1a1a14", lineHeight: 1.25, margin: 0 }}>Камерный<br/>формат</p>
            </div>
          </div>

          {/* ── CARD 02 top-right ── */}
          <div style={{ position: "absolute", left: "75%", top: "9%", width: "22%", height: "40%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "4% 4% 5%" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(20px, 2.8vw, 42px)", fontWeight: 300, color: "rgba(168,197,181,0.7)", lineHeight: 1 }}>02</span>
              <div style={{ width: "clamp(28px,2.8vw,42px)", height: "clamp(28px,2.8vw,42px)", borderRadius: "50%", border: "1px solid rgba(168,197,181,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(14px, 1.7vw, 24px)", fontWeight: 300, color: "#1a1a14", lineHeight: 1.25, margin: 0 }}>Спокойный<br/>процесс</p>
            </div>
          </div>

          {/* ── CARD 03 bottom-left ── */}
          <div style={{ position: "absolute", left: "52.5%", top: "51%", width: "21%", height: "40%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "4% 4% 5%" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(20px, 2.8vw, 42px)", fontWeight: 300, color: "rgba(168,197,181,0.7)", lineHeight: 1 }}>03</span>
              <div style={{ width: "clamp(28px,2.8vw,42px)", height: "clamp(28px,2.8vw,42px)", borderRadius: "50%", border: "1px solid rgba(168,197,181,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(14px, 1.7vw, 24px)", fontWeight: 300, color: "#1a1a14", lineHeight: 1.25, margin: 0 }}>Внимание<br/>к характеру</p>
            </div>
          </div>

          {/* ── CARD 04 bottom-right ── */}
          <div style={{ position: "absolute", left: "75%", top: "51%", width: "22%", height: "40%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "4% 4% 5%" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(20px, 2.8vw, 42px)", fontWeight: 300, color: "rgba(168,197,181,0.7)", lineHeight: 1 }}>04</span>
              <div style={{ width: "clamp(28px,2.8vw,42px)", height: "clamp(28px,2.8vw,42px)", borderRadius: "50%", border: "1px solid rgba(168,197,181,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(14px, 1.7vw, 24px)", fontWeight: 300, color: "#1a1a14", lineHeight: 1.25, margin: 0 }}>Постоянный<br/>мастер</p>
            </div>
          </div>
